...
guiSettings.value.guiSetting["activeSphereType"].onChange(value);
```
...
| 文件 | 影响原因 |
|-----|---------|
| `components/segmentation/Calculator.vue` | `guiSettings.guiState["activeSphereType"]`, `guiSetting.onChange()` |
